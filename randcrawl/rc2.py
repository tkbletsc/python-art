...
h=1200*2
dist=1
color_map_func = map_icecool_rev
...
# q=pixel count
# d=tree depth
def pick_dir_rand(x,y,q,d,w,h):
	return shuffled_dirs()

def pick_dir_fixed(x,y,q,d,w,h):
	return ['u','d','l','r']
...
Dn = 128
rot_dirs = ['u','d','l','r']
rot_dirs = [random.choice("udlr") for x in range(Dn)]
def pick_dir_rot1(x,y,q,d,w,h):
	global rot_dirs
	rot_dirs = rotate(rot_dirs,1)
	return rot_dirs
	
def pick_dir_rot1R1(x,y,q,d,w,h):
	global rot_dirs
	rot_dirs = rotate(rot_dirs,1)
...
def pick_dir_rot1R2(x,y,q,d,w,h):
	global rot_dirs
	rot_dirs = rotate(rot_dirs,1)
	if random.random()<0.01:
		rot_dirs = rotate(rot_dirs,1)
...
def pick_dir_rot1Rr(x,y,q,d,w,h):
	global rot_dirs
	rot_dirs = rotate(rot_dirs,1)
	if random.random()<0.01:
		rot_dirs = rotate(rot_dirs,random.randint(1,3))
	return rot_dirs
	
def pick_dir_rot1RrD(x,y,q,d,w,h):
	global rot_dirs
	rot_dirs = rotate(rot_dirs,1)
	if random.random()<0.02:
		rot_dirsQ = rotate(rot_dirs,1)
	if random.random()<0.001:
		rot_dirsQ = [random.choice("udlr") for x in range(Dn)]
	return rot_dirs
	
rot_dirsX = ['u','l','d','r']
def pick_dir_rot1X(x,y,q,d,w,h):
	global rot_dirsX
	rot_dirsX = rotate(rot_dirsX,1)
	return rot_dirsX
	
def pick_dir_rot1XR1(x,y,q,d,w,h):
	global rot_dirsX
	rot_dirsX = rotate(rot_dirsX,1)
	if random.random()<0.01:
		rot_dirsX = rotate(rot_dirsX,1)
...
def pick_dir_rot1XR2(x,y,q,d,w,h):
	global rot_dirsX
	rot_dirsX = rotate(rot_dirsX,1)
	if random.random()<0.1:
		rot_dirsX = rotate(rot_dirsX,2)
	return rot_dirsX
	
def pick_dir_rot1XRr(x,y,q,d,w,h):
	global rot_dirsX
	rot_dirsX = rotate(rot_dirsX,1)
	if random.random()<0.1:
		rot_dirsX = rotate(rot_dirsX,random.randint(1,3))
	return rot_dirsX
	
def pick_dir_rot1XRrC(x,y,q,d,w,h):
	global rot_dirsX
	rot_dirsX = rotate(rot_dirsX,1)
	if random.random()<0.2:
		rot_dirsX = rotate(rot_dirsX,random.randint(1,3))
	if random.random()<0.001:
		rot_dirsX = shuffled_dirs()
	return rot_dirsX
...
pick_dir_func = pick_dir_rot1RrD
input_filename = None
...
if input_filename:
    ...
    img = do_walk(w,h,pick_dir_func,dist,start_x=0,start_y=0,map_on=map_on,print_progress=True)
