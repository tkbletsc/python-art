...
def do_randwalk(w, h, dist=1, start_x=None, start_y=None, map_on='tree_depth', inline_colormap=None, print_progress=True):
...
if input_filename:
    ...
    img = do_randwalk(w,h,dist,map_on=map_on,print_progress=True)
